...
class Quote {
    ...
    // GET quotes (read all) – supports filtering if author_id and/or category_id are set
    ...
    // Read a single quote by id using LEFT JOIN to return the quote even if join data is missing.
